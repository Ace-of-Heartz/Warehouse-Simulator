...
namespace WarehouseSimulator.View.Playback
{
    public class UnityPlaybackManager : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            GameObject.Find("UIGlobalManager")?.GetComponent<BindingSetupManager>()
                .SetupPlaybackBinding(playbackManager);
        }
        ...
        void DebugSetup()
        {
            debugPbInputArgs.MapFilePath =
                "/Users/gergogalig/Library/CloudStorage/OneDrive-EotvosLorandTudomanyegyetem/FourthSemester/Szofttech/sample_files/maps/warehouse.map";
            debugPbInputArgs.EventLogPath =
                "/Users/gergogalig/Library/CloudStorage/OneDrive-EotvosLorandTudomanyegyetem/FourthSemester/Szofttech/sample_files/warehouse_100_log.json";
        }
        ...
        private void AddUnityPbRobot(object sender, RobotCreatedEventArgs e)
        {
            if (e.Robot is PbRobot pbRobie)
            {
                ...
                robieManager.MyThingies(pbRobie, unityMap, playbackManager, null);
            }
            else
            {
#if DEBUG
